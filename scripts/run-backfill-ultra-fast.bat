@echo off
REM ULTRA-FAST October backfill - Maximum ACE API limits
...
REM MAXIMUM PERFORMANCE SETTINGS (from ACE Swagger docs):
REM - page_size: 500000 (MAXIMUM allowed by ACE API - see Swagger enum)
REM - chunk_minutes: 120 (2 hours = fewer chunks, more data per chunk)
REM - max_chunks: 9999 (process entire month without stopping)
REM
REM Expected performance:
REM - ~2-4M records per 2-hour chunk (vs 400k-800k with smaller page size)
REM - ~350 total chunks (29 days * 12 chunks/day)
REM - ~8-10 hours completion (vs 15+ with 100k page size)

C:\Users\jstahr\AppData\Local\Programs\Python\Python311\python.exe scripts\python\backfill_paginated_raw.py --site ses_falls_city --start 2025-10-01T00:00:00Z --end 2025-10-29T23:59:59Z --chunk-minutes 120 --page-size 500000 --max-chunks 9999
