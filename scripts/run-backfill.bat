@echo off
REM Optimized October backfill - full month processing
...
REM Increased max-chunks from 200 to 9999 to process full month
REM Increased chunk-minutes from 30 to 60 to reduce API overhead
C:\Users\jstahr\AppData\Local\Programs\Python\Python311\python.exe scripts\python\backfill_paginated_raw.py --site ses_falls_city --start 2025-10-01T00:00:00Z --end 2025-10-29T23:59:59Z --chunk-minutes 60 --page-size 100000 --max-chunks 9999
