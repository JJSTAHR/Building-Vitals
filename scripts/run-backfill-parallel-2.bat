@echo off
REM Parallel backfill - October 11-20
...
C:\Users\jstahr\AppData\Local\Programs\Python\Python311\python.exe scripts\python\backfill_paginated_raw.py --site ses_falls_city --start 2025-10-11T00:00:00Z --end 2025-10-20T23:59:59Z --chunk-minutes 60 --page-size 100000 --max-chunks 9999
