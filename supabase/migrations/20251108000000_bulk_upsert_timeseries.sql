...
COMMENT ON FUNCTION public.bulk_upsert_timeseries IS
'Fast bulk upsert for Flightdeck API data. Takes site_id and raw JSONB array of {name, value, time} objects. Handles point creation and timeseries insertion in a single transaction.';
